...
public class Fraction {
	 ...
	 * values Postconditions: None Returns: A Fraction representing the differenct
	 * of the two fractions a & b
	 ***********************************************************/
	...
	/**********************************************************
	 * Method: main Purpose: Show how to create some Fraction objects and then call
	 * methods to manipulate them Parameters: an array of Strings, expected to be
	 * empty Preconditions: None Postconditions: None
	 ***********************************************************/
