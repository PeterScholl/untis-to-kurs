...
public class Turtle extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
	/**
	 * 
	 */
	...
	public Turtle(Controller c) {
		this(currentWidth, currentHeight,c);
	}

	public Turtle(int b, int h, Controller c) {
		this.c=c;
		if (firstCall) {
			firstCall = false;
			jFrame = null;
...
//--------- administration -------------------------------------------------
	...
	private void initComponents(int b, int h) {
		...
		closeButton = new JButton("Programm beenden");
...
//----------------englisch ------------------------
	...
	public void mousePressed(MouseEvent e) {
		...
		c.grabPos(e.getX(),e.getY()-63);
	}

	@Override
	public void mouseReleased(MouseEvent e) {
		System.out.println(e);		
		c.released(e.getX(), e.getY()-63);
	}
